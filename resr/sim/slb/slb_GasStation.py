...
class Car(sim.Component):
    ...
    def process(self):
        ...
        # Alternatives:
        # -evoke a function of the Pump everytime fuel is pumped
        # -define a trigger everytime ...
        # -call a Car fueling function that does the fueling and "reorder" check sequentially
        # -code the "reorder" within the Car process rather than the Pump process
